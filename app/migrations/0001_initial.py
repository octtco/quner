# Generated by Django 5.1.7 on 2025-04-19 05:24
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "detailAddress",
                    models.CharField(
                        default="", max_length=255, verbose_name="景点详情地址"
                    ),
                ),
                (
                    "shortIntro",
                ...
                (
                    "detailUrl",
                    models.CharField(
                        default="", max_length=255, verbose_name="详情地址"
                    ),
                ),
                (
                    "score",
                ...
                (
                    "commentsLen",
                    models.CharField(
                        default="", max_length=255, verbose_name="评论个数"
                    ),
                ),
                (
                    "detailIntro",
                    models.CharField(
                        default="", max_length=2555, verbose_name="详情介绍"
                    ),
                ),
                (
                    "img_list",
                    models.CharField(
                        default="", max_length=2550, verbose_name="图片列表"
                    ),
                ),
